...
1、下载 examples/nginx-1.29.8-image/packages/nginx-1.29.8.tar.gz 包。

全局替换 `examples/nginx-1.29.8-image` 目录下面的 `1.24.0` 为 `1.29.8`。

```sh
cd nginx-1.29.8-image/packages
# 解压 xxx.tar.gz 包
